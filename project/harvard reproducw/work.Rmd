...
## TO DO settle the conflict, copy all related libs
```{r}
# Helper packages
...
```
##2.1.SUBSET DATA
##to consider also categorical var
matching data (to do)A
```{r}
#subset with num var only
...
```
#consider to add more cols OR NOT
```{r}
